...
<body>
  ...
  <div id="top">
    <h1>ПРОФЕСІЙНИЙ РЕМОНТ АВТОМОБІЛІВ</h1>
    <div>Автосервіс з ремонту та обслуговування автомобілів</div>
    <div class="main_button_2"><a class="main_button" onclick="openModal()"> </a></div>
  </div>

  <div id="contacts">
    <center><h5>Заповніть форму і дізнайтеся вартість ремонту просто зараз!</h5></center>
    <h3 style="text-align: center; background-color: lightblue">Ми зв'яжемося з Вами якумога скоріше!</h3>

    <form id="form_input" method="POST" action="form_handler.php">
      ...
      <label for="tel">Ваш номер телефону <span>*</span></label><br>
      <input type="tel" placeholder="Введіть номер" name="tel" id="tel"><br>
      <label for="message">Опишіть вашу проблему з авто<span>*</span></label><br>
      <textarea style="font-size: 1.2em; height: 150px; width: 80%" placeholder="Введіть ваше повідомлення" name="message" id="message"></textarea><br>
